<x-app-layout>
    ...
    <script>
        window.sectionIndex = {{ $page->sections->count() }};
    </script>
        ...
        <div class=" p-4 mb-3" style="margin-bottom: 20px">            
            ...
            <form action="{{ route('update.page', $page->id) }}" method="post">
                ...
                <div class="pole">
                    ...
                    <input type="text" name="name" id="" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" value="{{ old('name', $page->name) }}">    
                </div>

                <div class="pole">
                    <div class="label-popis block font-medium text-sm text-gray-700">URL adresa</div>
                    <input type="text" name="slug" id="" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" value="{{ old( 'slug', $page->slug) }}">    
                </div>
